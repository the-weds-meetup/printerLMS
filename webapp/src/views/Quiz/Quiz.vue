  ...
  <div class="container">
    <form>
      ...
      <div v-if="questionIndex < questions.length">
        ...
        <br />
        <button type="button" class="btn btn-info" @click="verify">
          Submit
        </button>
        <button type="button" class="btn btn-danger verify" @click="submit">
          Next</button
        ><br /><br />
        <div id="message"></div>
        <p>score: {{ score }}</p>
  ...
  methods: {
    ...
    verify() {
      ...
      if (this.answer === this.question.rightAnswer) {
        ...
        document.getElementById('message').innerHTML =
          'You are wrong! Correct answer: ' + this.question.rightAnswer + '.';
      }
    },
    restart() {
